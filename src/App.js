...
export default function App() {
  ...
  const saveFile = () => {
    let save = document.getElementsByClassName("medium-editor-element")[0]
      .outerText;
    console.log(document.getElementsByClassName("medium-editor-element"));
    ...
    <>
      ...
      <div className="tips show">
        ...
        <div className="tips-content-text">
          ...
          browser even if you close the tab! Highlight text to format it, or use
          the shortcuts below.
          <hr />
